...
if __name__ == "__main__":
    ...
    # Testing
    schedule.every().minute.at(":00").do(bot.send, send_any_string, "sechedule-1").tag('schedule-1')
    schedule.every().minute.at(":00").do(bot.send, send_any_string, "sechedule-2").tag('schedule-2')
    schedule.every().minute.at(":00").do(bot.send, send_any_string, "sechedule-3").tag('schedule-3')
    schedule.every().minute.at(":00").do(bot.send, send_any_string, "sechedule-4").tag('schedule-4')
